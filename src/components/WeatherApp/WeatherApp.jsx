            ...
            <div className="weather-image">
                ...
                <footer className="fixed bottom-0 p-4 footer bg-base-100 border-t-2 border-base-200 text-base-content footer-center">
                    ...
                    <p style={{ color: "white" }}>Engineered by Gaurav Kumar🚀</p>
                        <a href="https://github.com/gks2022004/weather-app" target="https://github.com/gks2022004/weather-app" className='flex items-center hover:underline font-bold cursor-pointer'>
